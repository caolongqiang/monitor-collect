...
import com.jimu.monitor.utils.http.ext.AuthSSLProtocolSocketFactory;
import com.jimu.monitor.utils.http.ext.EasySSLProtocolSocketFactory;
...
public abstract class AbstractHttpClient {
    ...
    AbstractHttpClient() {
        connectionTimeout(DefaultConfig.DEFAULT_CONN_TIME);
        socketTimeout(DefaultConfig.DEFAULT_SOCKET_TIME);
    }
